...
#for 2 streams: RR minrtt ECF PATS
# fileparam["random0"].extend([50000, 255, 0])
# fileparam["random1"].extend([50000, 255, 0])
...
# fileparam["random-low-big"].extend([100000, 255, 0])
...
# for 3 different priority streams (5MB(40Mb))
# fileparam["random-high"].extend([50000, 255, 0])
# fileparam["random-medium"].extend([50000, 150, 0])
# fileparam["random-low"].extend([50000, 50, 0])

# for 3 same priority streams (5MB(40Mb))
# fileparam["random-high"].extend([50000, 255, 0])
# fileparam["random-medium"].extend([50000, 255, 0])
# fileparam["random-low"].extend([50000, 255, 0])
